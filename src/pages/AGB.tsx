      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="p-6">
          <div className="prose prose-slate prose-lg dark:prose-invert max-w-none">
            ...
            <h2>5. Kostenpflichtige Dienste und Abonnements</h2>
            <p>
            ...
            <ul>
              ...
              <li><strong>Zahlungsbedingungen:</strong> Zahlungen sind im Voraus fällig. Die Kündigung des Abonnements erfolgt direkt in der App. Du kannst das Abonnement jederzeit kündigen. Es erfolgt keine Rückerstattung bereits bezahlter Beträge, jedoch kannst du kostenpflichtige Funktionen der App bis zum Ende des laufenden Abrechnungszeitraums weiterhin nutzen.</li>
            </ul>
